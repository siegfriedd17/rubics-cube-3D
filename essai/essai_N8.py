...
def shadow(points_list, face, color, div):
    ...
    for i in face:
        ...
        print(dot_product_light(vect_normal,vect_abs,1))
        print(dot_product_light(vect_normal,vect_ord,1))
...
def cube(points_list_2d, nvx_face, div, ordre, couleur):
    """dessine un cube 3d """
...
def affichage(points_list, face, couleur, div, res_fenetre):
    ...
    while tour <= fps and run is True:
        ...
        cube (points_list_2d, nvx_face, div, ordre, couleur_fps)
...
def main():
    ...
    affichage(points_list, face, couleur, div, res_fenetre)
